                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <button class="btn btn-sm btn-warning"><a href="{{ route('admin_detail_pengajuan', 'order35353') }}"><i class="ri-eye-fill m-auto"></i></a></button>
                                        <button class="btn btn-sm btn-primary mx-2">
                                          <a href="{{ route('admin_edit_pengajuan', 'order35353') }}"><i class="ri-edit-fill"></i></a></button>
